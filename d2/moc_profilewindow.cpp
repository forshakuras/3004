...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Profilewindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 36, 0)
    ...
    "Profilewindow\0on_pushButton_clicked\0"
    "\0"
};
...
const QMetaObject Profilewindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Profilewindow.data,
      qt_meta_data_Profilewindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Profilewindow.stringdata))
