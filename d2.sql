...
--=======================
begin transaction;
insert into projects(title,description,idealNumberStudents,maxStudents,currentStudents,gpa,pmSkill,database,java,cCpp,jsHtml,python,debuggingTesting,documentation,mobile,networking,ui,algorithm) values ('3004 D2','CUPID deliverable 2',3,4,0,3.5,3,3,3,3,3,3,3,3,3,3,3,2);
...
insert into projects(title,description,maxStudents,idealNumberStudents,currentStudents,gpa,pmSkill,database,java,cCpp,jsHtml,python,debuggingTesting,documentation,mobile,networking,ui,algorithm) values ('3004 D4','CUPID deliverable 4',3,4,4,3.5,3,3,3,3,3,3,3,3,3,3,3,2);
end transaction;
...
insert into studentList(student_number,projectId) values (100111111,1);
insert into studentList(student_number,projectId) values (100111222,1);
