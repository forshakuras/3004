...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_chooseWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 64, 24)
    ...
    "chooseWindow\0on_profileButton_clicked\0"
    "\0on_projectButton_clicked\0"
    "on_signoutBUtton_clicked\0"
};
...
void chooseWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_signoutBUtton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject chooseWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_chooseWindow.data,
      qt_meta_data_chooseWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_chooseWindow.stringdata))
