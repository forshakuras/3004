...
public:
    ...
    void setupUi(QDialog *projectDesc)
    {
        ...
        line_2 = new QFrame(projectDesc);
        line_2->setObjectName(QStringLiteral("line_2"));
        line_2->setGeometry(QRect(470, 0, 20, 591));
        line_2->setFrameShape(QFrame::VLine);
        line_2->setFrameShadow(QFrame::Sunken);
        memberlist = new QListView(projectDesc);
        memberlist->setObjectName(QStringLiteral("memberlist"));
        memberlist->setGeometry(QRect(490, 80, 181, 471));
        label_18 = new QLabel(projectDesc);
        label_18->setObjectName(QStringLiteral("label_18"));
        label_18->setGeometry(QRect(540, 30, 101, 41));
    ...
    void retranslateUi(QDialog *projectDesc)
    {
        ...
        label_18->setText(QApplication::translate("projectDesc", "Member List", 0));
    } // retranslateUi
